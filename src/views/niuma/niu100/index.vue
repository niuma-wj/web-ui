    ...
    <el-row :gutter="20">
      <el-col :span="24" :xs="24">
        ...
        <el-table v-loading="loading" :data="roomList">
          ...
          <el-table-column label="奖池押金" align="center" prop="deposit" />
          <el-table-column label="公开" align="center" width="60">
            <template slot-scope="scope">
              <span>{{ getPublic(scope.row.isPublic) }}</span>
            </template>
          </el-table-column>
...
<script>
import { listNiu100 } from "@/api/niuma/game";
export default {
  name: "Niu100",
  data() {
    return {
  ...
  methods: {
    ...
    getList() {
      ...
      listNiu100(this.queryParams).then((response) => {
